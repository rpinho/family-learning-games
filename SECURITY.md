...
The code includes bounded inputs, same-origin/host checks, revision checks and restricted static routes. Those protections do not replace authentication, authorization, TLS, rate limiting, security review or a data-retention policy. The visible Admin option and reading-and-code parent gate are not security controls against a determined person.
