...
const files=['index.html','hub.mjs','style.css','bridge.mjs','dribble-ui.mjs','dribble-live.mjs','reading-reward.mjs','live-pitch.mjs','pitch.mjs','save-request.mjs','icon.svg','icon-192.png','icon-512.png','manifest.webmanifest'];
