...
export function roundRecap({game,advanced,correct,independent,entries=[],player}){
 ...
 return {lines,treats:feeds(player)?correct:0};
}
export function recapVoiceLines(){
 const lines=new Set([RECAP_NONE,RECAP_ALL_OWN]);
 for(let n=1;n<=6;n++){
