...
for(const size of [16,32,48,180,192,512])files[`/icons/app-${size}-v1.png`]=`icons/app-${size}-v1.png`;
files['/icons/favicon-v1.ico']='icons/favicon-v1.ico';files['/favicon.ico']='icons/favicon-v1.ico';files['/manifest.webmanifest']='manifest.webmanifest';
